...
## Corpus Check
- 263 files · ~208,413 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1426 nodes · 2736 edges · 88 communities (71 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `35aabbe4`
...
9. `Button` - 15 edges
10. `verifySupervisorScope()` - 13 edges
...
- `GET()` --calls--> `createClient()`  [EXTRACTED]
  app/api/analytics/worker-productivity/route.ts → lib/supabase/server.ts
...
Cohesion: 0.09
Nodes (28): GET(), GET(), GET(), POST(), mapStatusToStage(), POST(), POST(), POST() (+20 more)
...
Cohesion: 0.08
Nodes (21): ConfirmationFormField(), PackagingFormField(), ALL_MAT_TYPES, ALL_TX_TYPES, CertRow, ComplRow, Field, FieldItem (+13 more)
...
Cohesion: 0.07
Nodes (26): POST(), ROLE_CONFIGS, RoleConfig, Step, WorkerInfo, isLoginRole(), ALL_ROLES, AllRole (+18 more)

### Community 6 - "Client Session Management"
Cohesion: 0.11
Nodes (20): POST(), POST(), POST(), GET(), POST(), GET(), GET(), DELETE() (+12 more)
...
Cohesion: 0.07
Nodes (30): POST(), GET(), POST(), ALLOWED_TYPES, GET(), POST(), GET(), GET() (+22 more)
...
Cohesion: 0.08
Nodes (15): formatDate(), FormConfig, getTheme(), GROUP_THEME, OrderDetailData, Phase, ROLE_STAGE_MAP, STAGE_LABELS (+7 more)
...
Cohesion: 0.05
Nodes (49): BottleneckTableRow(), formatHours(), getStatusInfo(), BottleneckHeatmap(), fmtCount(), HeatmapData, CycleStageData, CycleTimeData (+41 more)

### Community 20 - "Marketing Channel Dashboard"
Cohesion: 0.11
Nodes (14): BANKS, RecentInput, StatsData, iconMap, menuItems, SidebarProps, iconMap, menuItems (+6 more)

### Community 21 - "Data Viewer Utilities"
Cohesion: 0.05
Nodes (25): ActionState, CHECKLIST_LABELS, FilterTab, formatRelative(), KEY_LABELS, PendingCard(), PendingItem, VALUE_LABELS (+17 more)
...
Cohesion: 0.10
Nodes (14): Task, TaskItem, getClientUser(), isRoleDetailObject(), isRoleGroup(), LOGIN_ROLES, LoginRole, RoleGroup (+6 more)
...
Cohesion: 0.12
Nodes (11): MarketingChannel, Channel, CSInput, CSUser, InputMarketingPage(), AlertProps, ModalProps, MarketingInput (+3 more)
...
Cohesion: 0.16
Nodes (16): ALLOWED_TYPES, POST(), ALLOWED_FORM_FIELDS, DELETE(), PUT(), generateOrderNumber(), GET(), POST() (+8 more)
...
Cohesion: 0.13
Nodes (10): HeaderProps, ProfileData, ProfileData, SettingsModalProps, ConfirmDialogProps, ConfirmVariant, variantConfig, clearClientUser() (+2 more)
...
Cohesion: 0.11
Nodes (12): ActiveTab, Assignment, PersonnelResponse, PersonnelUser, SlotCategory, SlotOverride, UserInfo, KpiApiResponse (+4 more)
...
Cohesion: 0.11
Nodes (13): LeadInput, formatRupiah(), PelangganGroup, PelangganOrder, PelangganPage(), HistoryEntry, Task, TaskItem (+5 more)

### Community 58 - "Supervisor QR Codes"
Cohesion: 0.10
Nodes (26): ACTIVE_STAGES, StageBottleneck, APPROVAL_GATE_MAP, POST(), resolveIngestionStage(), GET(), APPROVAL_STAGES, APPROVAL_TO_PRODUCTION_STAGE (+18 more)
...
## Knowledge Gaps
- **446 isolated node(s):** `APPROVAL_GATE_MAP`, `FieldType`, `StageType`, `FieldConfig`, `StageConfig` (+441 more)
...
- **Why does `createClient()` connect `Superadmin QR API` to `Supervisor API Routes`, `Supervisor Order Monitoring`, `Order Creation API`, `Workshop Login Pages`, `Client Session Management`, `Scan Event Analytics`, `KPI Data Fetching`, `Order Detail API`, `User Auth API`, `Manager Task Monitoring`, `BMS Role Management`, `Monthly Insights API`, `CSV Export Utilities`, `Order Action Handlers`, `Weekly Activity API`, `Financial Formatting API`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `fetcher()` connect `Order Detail Popup` to `User and Branch Forms`, `Account Management Modals`, `Workshop Login Pages`, `Expert Performance Analytics`, `User Administration API`, `Branch Statistics Dashboard`, `Daily Analysis Dashboard`, `Management History Dashboard`, `TypeScript Configuration`, `Marketing Channel Dashboard`, `Data Viewer Utilities`, `Order Form Helpers`, `Owner KPI Dashboard`, `Customer Stage Progress`, `Dashboard Activity Feed`, `Lead Input Management`, `Order Entry Page`, `QR Code Management`, `PIN Settings Page`, `User Profile Modals`, `Report Generation Page`, `Report Selection Page`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `createAdminClient()` connect `Supervisor API Routes` to `Supervisor Order Monitoring`, `Order Creation API`, `Client Session Management`, `Scan Event Analytics`, `Order Status Lookup`, `Superadmin QR API`, `KPI Data Fetching`, `User Auth API`, `BMS Role Management`, `Financial Formatting API`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **What connects `APPROVAL_GATE_MAP`, `FieldType`, `StageType` to the rest of the system?**
