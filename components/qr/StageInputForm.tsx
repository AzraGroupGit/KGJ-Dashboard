...
const ALL_MAT_TYPES: MaterialType[] = [
  "gold",
  "silver",
  "platinum",
  "alloy",
...
const lCls = "mb-1 block text-[10px] uppercase tracking-wider text-stone-400";

// ─── LeburBahanMaterialField ──────────────────────────────────────────────────

function LeburBahanMaterialField({
  value,
  onChange,
  disabled,
  error,
  ...
  // Ensure we have exactly 2 rows: one output, one waste
  const rows =
    value.length === 0
      ? [
          {
            transaction_type: "output" as TransactionType,
          ...
          {
            transaction_type: "waste" as TransactionType,
            material_type: "gold" as MaterialType,
            karat: "" as number | "",
            weight_grams: "" as number | "",
            notes: "",
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-emerald-200 bg-emerald-50/30 p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              value={rows[0]?.material_type ?? "gold"}
              onChange={(e) =>
                updOutput({ material_type: e.target.value as MaterialType })
              }
              disabled={disabled}
              className={sCls}
            >
          ...
          <div>
            ...
            <input
              type="number"
              value={rows[0]?.karat === "" ? "" : rows[0]?.karat}
              onChange={(e) =>
                updOutput({
                  karat: e.target.value === "" ? "" : Number(e.target.value),
                })
              }
              placeholder="18"
              min={0}
        ...
        <div>
          <label className={lCls}>
            Berat Hasil Cetakan (gram) <span className="text-red-400">*</span>
          </label>
          <input
            type="number"
            value={rows[0]?.weight_grams === "" ? "" : rows[0]?.weight_grams}
            onChange={(e) =>
              updOutput({
                weight_grams:
        ...
        <div>
          ...
          <input
            type="text"
            value={rows[0]?.notes ?? ""}
            onChange={(e) => updOutput({ notes: e.target.value })}
      ...
      <div className="rounded-xl border border-rose-200 bg-rose-50/30 p-4 space-y-3">
        <div className="flex items-center gap-2">
          <span className="flex h-6 w-6 items-center justify-center rounded-full bg-rose-500 text-white text-[11px] font-bold">
            2
          </span>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className={lCls}>Jenis Bahan</label>
            <select
              value={rows[1]?.material_type ?? "gold"}
              onChange={(e) =>
                updWaste({ material_type: e.target.value as MaterialType })
              }
              disabled={disabled}
              className={sCls}
            >
          ...
          <div>
            ...
            <input
              type="number"
              value={rows[1]?.karat === "" ? "" : rows[1]?.karat}
              onChange={(e) =>
                updWaste({
                  karat: e.target.value === "" ? "" : Number(e.target.value),
                })
        ...
        <div>
          ...
          <input
            type="number"
            value={rows[1]?.weight_grams === "" ? "" : rows[1]?.weight_grams}
            onChange={(e) =>
              updWaste({
                weight_grams:
                  e.target.value === "" ? "" : Number(e.target.value),
        ...
        <div>
          ...
          <input
            type="text"
            value={rows[1]?.notes ?? ""}
            onChange={(e) => updWaste({ notes: e.target.value })}
            placeholder="Opsional"
            disabled={disabled}
            className={iCls}
          />
...
function PembentukanMaterialField({
  value,
  onChange,
  disabled,
  error,
  ...
  const rows =
    value.length === 0
      ? [
          {
            transaction_type: "input" as TransactionType,
            material_type: "gold" as MaterialType,
            karat: "" as number | "",
            weight_grams: "" as number | "",
            notes: "",
  ...
  const sections: {
  ...
  }[] = [
    {
      index: 0,
      type: "input",
      label: "Bahan Input (Sebelum Dibentuk)",
  ...
  return (
    <div className="space-y-4">
      {sections.map((section) => (
        <div
          key={section.type}
          className={`rounded-xl border ${section.color} ${section.bgColor} p-4 space-y-3`}
        >
          <div className="flex items-center gap-2">
            <span className="flex h-6 w-6 items-center justify-center rounded-full bg-stone-600 text-white text-[11px] font-bold">
              {section.index + 1}
            </span>
            <span className={`text-[13px] font-semibold ${section.textColor}`}>
              {section.label}
              {section.required && (
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className={lCls}>Jenis Bahan</label>
              <select
                value={rows[section.index]?.material_type ?? "gold"}
                onChange={(e) =>
                  updRow(section.index, {
          ...
          <div>
            ...
            <input
              type="number"
              value={
                rows[section.index]?.weight_grams === ""
                  ? ""
                  : rows[section.index]?.weight_grams
              }
              onChange={(e) =>
          ...
          <div>
            ...
            <input
              type="text"
              value={rows[section.index]?.notes ?? ""}
              onChange={(e) =>
                updRow(section.index, {
...
function PemasanganPermataMaterialField({
  value,
  onChange,
  disabled,
  error,
  ...
  const sections: {
  ...
  }[] = [
    {
      index: 0,
      type: "input",
      label: "Bahan Sebelum Pasang Batu",
      color: "border-blue-200",
      bgColor: "bg-blue-50/30",
      textColor: "text-blue-800",
      required: true,
    },
    {
      index: 1,
      type: "output",
      label: "Hasil Setelah Pasang Batu",
      color: "border-emerald-200",
      bgColor: "bg-emerald-50/30",
      textColor: "text-emerald-800",
      required: true,
  ...
  return (
    <div className="space-y-2">
      ...
      {value.map((row, i) => (
        <div
          key={i}
          className="rounded-xl border border-stone-200 bg-stone-50/30 p-3 space-y-2"
        >
          <div className="flex items-center justify-between">
            ...
            {!disabled && (
              <button
                type="button"
                onClick={() => remove(i)}
                className="rounded-md px-2 py-0.5 text-[11px] font-medium text-red-400 hover:bg-red-50 hover:text-red-600 transition-colors"
              >
                Hapus
              </button>
            )}
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              {allowed.length === 1 ? (
                <div className="rounded-lg border border-stone-200 bg-stone-100 py-2 px-3 text-[13px] text-stone-500">
                  {TX_TYPE_LABELS[allowed[0]]}
                </div>
              ) : (
                <select
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  upd(i, { material_type: e.target.value as MaterialType })
                }
                disabled={disabled}
                className={sCls}
              >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <input
                type="number"
                value={row.weight_grams === "" ? "" : row.weight_grams}
                onChange={(e) =>
                  upd(i, {
                    weight_grams:
                      e.target.value === "" ? "" : Number(e.target.value),
      ...
      {!disabled && (
        <button
          type="button"
          onClick={add}
          className="flex w-full items-center justify-center gap-1.5 rounded-xl border border-dashed border-amber-300 py-2.5 text-[13px] font-medium text-amber-600 hover:border-amber-400 hover:bg-amber-50 transition-colors"
        >
...
function QualityChecklistField({
  items,
  value,
  onChange,
  disabled,
  ...
  const toggle = (key: string) =>
    onChange(
      value.map((r) => (r.check_key === key ? { ...r, passed: !r.passed } : r)),
    );
      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            <span
              className={`text-[11px] font-semibold ${passed ? "text-emerald-600" : "text-rose-400"}`}
            >
              {passed ? "OK ✓" : "Gagal"}
            </span>
          </button>
...
function CompletenessListField({
  items,
  value,
  onChange,
  disabled,
  ...
  const toggle = (key: string) =>
    onChange(
      value.map((r) =>
        r.item_key === key ? { ...r, checked: !r.checked } : r,
      ),
    );
      ...
      {items.map((item) => {
        ...
        return (
          ...
          >
            ...
            <span
              className={`text-[11px] font-semibold ${checked ? "text-blue-600" : "text-stone-400"}`}
            >
              {checked ? "Ada ✓" : "Belum"}
            </span>
          </button>
    ...
    <div className="rounded-xl border border-stone-200 bg-stone-50/30 p-3 space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <select
            value={value.confirmation_type ?? "initial"}
            onChange={(e) => upd("confirmation_type", e.target.value)}
            disabled={disabled}
            className={sCls}
          >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => upd("confirmation_method", e.target.value)}
            disabled={disabled}
            className={sCls}
          >
      ...
      <div>
        <label className={lCls}>
          Status Konfirmasi <span className="text-red-400">*</span>
        </label>
        <select
          value={status}
          onChange={(e) => upd("confirmation_status", e.target.value)}
          disabled={disabled}
          className={sCls}
        >
      ...
      {status === "approved" && (
        <div>
          ...
          <input
            type="datetime-local"
            value={value.confirmed_at ?? ""}
            onChange={(e) => upd("confirmed_at", e.target.value)}
            disabled={disabled}
            className={iCls}
          />
        </div>
    ...
    <div className="rounded-xl border border-stone-200 bg-stone-50/30 p-3 space-y-3">
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            type="text"
            value={value.box_type ?? ""}
            onChange={(e) => upd("box_type", e.target.value)}
        ...
        <div>
          ...
          <input
            type="text"
            value={value.gift_type ?? ""}
            onChange={(e) => upd("gift_type", e.target.value)}
            placeholder="Contoh: Gift wrap, Pouch"
            disabled={disabled}
            className={iCls}
          />
        </div>
      ...
      <div>
        ...
        <input
          type="text"
          value={value.price_list_version ?? ""}
          onChange={(e) => upd("price_list_version", e.target.value)}
          placeholder="Contoh: v2024-Q1"
          disabled={disabled}
          className={iCls}
        />
      </div>
...
function CertificateArrayField({
  value,
  onChange,
  disabled,
  error,
  ...
  const remove = (i: number) => onChange(value.filter((_, idx) => idx !== i));
  const upd = (i: number, p: Partial<CertRow>) =>
    onChange(value.map((r, idx) => (idx === i ? { ...r, ...p } : r)));

  return (
    <div className="space-y-2">
      {value.length === 0 && (
        <p className="rounded-xl border border-dashed border-stone-200 py-3 text-center text-[12px] text-stone-400">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <input
                ...
                onChange={(e) => upd(i, { certificate_type: e.target.value })}
                placeholder="GIA, IGI, dll"
                disabled={disabled}
                className={iCls}
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => upd(i, { certificate_number: e.target.value })}
                disabled={disabled}
                className={iCls}
              />
            </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <input
                ...
                onChange={(e) => upd(i, { issuing_body: e.target.value })}
                disabled={disabled}
                className={iCls}
              />
            </div>
            <div>
              ...
              <button
                type="button"
                onClick={() => upd(i, { is_verified: !row.is_verified })}
                disabled={disabled}
              ...
              >
                <span
                  className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-sm transition-transform ${row.is_verified ? "translate-x-6" : "translate-x-1"}`}
                />
              </button>
            </div>
          </div>
...
function PaymentArrayField({
  ...
  const add = () => onChange([...value, { ...blank }]);
  const remove = (i: number) => onChange(value.filter((_, idx) => idx !== i));
  const upd = (i: number, p: Partial<PaymentRow>) =>
    onChange(value.map((r, idx) => (idx === i ? { ...r, ...p } : r)));
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div>
              ...
              <input
                type="date"
                value={row.paid_at}
                onChange={(e) => upd(i, { paid_at: e.target.value })}
                disabled={disabled}
                className={iCls}
              />
            </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => upd(i, { reference_no: e.target.value })}
  ...
  return (
    <div className="rounded-xl border border-stone-200 bg-stone-50/30 p-3 space-y-3">
      <div>
        ...
        <select
          value={method}
          onChange={(e) => upd("delivery_method", e.target.value)}
          disabled={disabled}
          className={sCls}
        >
      ...
      {needsCourier && (
        <div>
          ...
          <input
            ...
            onChange={(e) => upd("courier_name", e.target.value)}
            placeholder="Contoh: JNE, Gojek"
            disabled={disabled}
            className={iCls}
          />
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => upd("recipient_phone", e.target.value)}
            placeholder="08xx"
            disabled={disabled}
            className={iCls}
          />
      ...
      {needsCourier && (
        <div>
          ...
          <textarea
            ...
            onChange={(e) => upd("delivery_address", e.target.value)}
            rows={2}
            disabled={disabled}
...
function DeliveryUpdateFormField({
  value,
  onChange,
  disabled,
  error,
  ...
  return (
    <div className="rounded-xl border border-stone-200 bg-stone-50/30 p-3 space-y-3">
      <div>
        <label className={lCls}>
          Status Pengiriman <span className="text-red-400">*</span>
        </label>
        <select
          value={value.status ?? ""}
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) => upd("tracking_number", e.target.value)}
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input
            type="datetime-local"
            value={value.dispatched_at ?? ""}
            onChange={(e) => upd("dispatched_at", e.target.value)}
            disabled={disabled}
            className={iCls}
          />
        </div>
        <div>
          ...
          <input
            type="datetime-local"
            value={value.delivered_at ?? ""}
            onChange={(e) => upd("delivered_at", e.target.value)}
            disabled={disabled}
            className={iCls}
          />
        </div>
  ...
  return (
    <div className="rounded-xl border border-stone-200 bg-stone-50/30 p-3 space-y-3">
      <div>
        ...
        <select
          value={value.handover_type ?? "store_to_customer"}
          onChange={(e) => upd("handover_type", e.target.value)}
          disabled={disabled}
          className={sCls}
        >
              ...
              {field.type === "material_array" && (
                <>
                  ...
                  field.transactionTypes.includes("waste") ? (
                    /* pembentukan_cincin — Input, Output, Waste */
                    <PembentukanMaterialField
                    ...
                    field.transactionTypes.includes("output") &&
                    !field.transactionTypes.includes("waste") ? (
                    /* pemasangan_permata — Input + Output only */
                    <PemasanganPermataMaterialField
                      value={(formData[field.name] as MaterialRow[]) ?? []}
                      onChange={(rows) => updateField(field.name, rows)}
                      disabled={!permissions.can_edit}
                    ...
                    /* Generic fallback: racik_bahan (input only), pemolesan, finishing */
                    <MaterialArrayField
                      value={(formData[field.name] as MaterialRow[]) ?? []}
                      onChange={(rows) => updateField(field.name, rows)}
