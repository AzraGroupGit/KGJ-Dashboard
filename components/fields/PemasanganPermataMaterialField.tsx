// components/fields/PemasanganPermataMaterialField.tsx
"use client";
...
export default function PemasanganPermataMaterialField({
  value,
  onChange,
  disabled,
  error,
  ...
  const sections: { index: number; type: TransactionType; label: string; color: string; bgColor: string; textColor: string; required: boolean }[] = [
    { index: 0, type: "input", label: "Bahan Sebelum Pasang Batu", color: "border-blue-200", bgColor: "bg-blue-50/30", textColor: "text-blue-800", required: true },
    { index: 1, type: "output", label: "Hasil Setelah Pasang Batu", color: "border-emerald-200", bgColor: "bg-emerald-50/30", textColor: "text-emerald-800", required: true },
  ];
