...
const ROLE_COLORS: Record<string, string> = {
  ...
  jewelry_expert_finishing: "bg-emerald-100 text-emerald-300",
        ...
        <header className="flex items-center justify-between border-b border-slate-100 px-5 py-3.5">
          ...
          <div className="flex items-center gap-2">
            <select
              ...
              className="rounded-md border border-slate-200 bg-[#2a2522] px-2 py-1 text-[11px] font-medium text-white/40 focus:outline-none"
            >
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {sorted.map((w, _i) => {
                  ...
                  const roleColor = ROLE_COLORS[w.roleName] || "bg-slate-100 text-white/40";
